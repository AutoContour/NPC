...
def build_res_V1(input_var, batch_size):
    ...
    net['input'] = InputLayer((batch_size, 4, None, None, None), input_var=input_var)
...
def train_model_res_V1(results_path, fine_tune=None, batch_size=5, base_lr=0.001, n_epochs=30):
...
if __name__ == '__main__':
    ...
    train_model_res_V1(results_path=results_path, fine_tune=True)
